namespace cadpat {
    ...
    export interface IBemResourceClass extends ng.resource.IResourceClass<IBemResource> {
    ...
    function BemResource($resource: ng.resource.IResourceService): IBemResourceClass {
